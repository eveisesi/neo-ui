    ...
    <b-table-simple borderless striped table-variant="active">
        <b-tbody>
            <b-tr>
                ...
                <b-td style="width:34" class="p-0">
                    <img
                        :src="EVEONLINE_IMAGE+'corporations/'+killmail.victim.corporation.id+'/logo?size=32'"
                    />
            ...
            <b-tr>
                ...
                <b-td>{{killmail.victim.ship.name}} ({{killmail.victim.ship.group.name}})</b-td>
            </b-tr>
            <b-tr>
                ...
                <b-td>
                    ...
                    <span
                        :class="killmail.system.security >= 0 ? 'text-success' : 'text-danger'"
                    >{{killmail.system.security.toFixed(2)}}</span>
                    ) / {{killmail.system.constellation.region.name}}
                </b-td>
            </b-tr>
            <b-tr>
